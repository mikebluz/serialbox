...
async function authorize() {
  ...
  creds['installed']['client_id'] = process.env.CLIENT_ID;
  creds['installed']['client_secret'] = process.env.CLIENT_SECRET;
  const newCreds = JSON.stringify(creds);
  await fs.writeFile(CREDENTIALS_PATH, newCreds);
